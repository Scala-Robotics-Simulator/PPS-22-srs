...
/**
 * The [[SimpleView]] provides a basic GUI setup to visualize formatted data in a non-editable text area. It is
 * primarily used as part of the view implementation in the [[ViewModule]], offering methods to initialize the GUI,
 * display data, and properly close the window.
 */
class SimpleView:
