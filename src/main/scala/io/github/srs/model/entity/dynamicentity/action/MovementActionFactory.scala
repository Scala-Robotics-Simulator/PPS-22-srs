...
object MovementActionFactory:
   ...
   *   they are not.
   */
  infix def customMove[F[_], E <: DynamicEntity](left: Double, right: Double): Validation[MovementAction[F, E]] =
    for
   ...
   */
  infix def moveForward[F[_], E <: DynamicEntity]: MovementAction[F, E] = MovementAction(maxSpeed, maxSpeed)
   ...
   */
  infix def moveBackward[F[_], E <: DynamicEntity]: MovementAction[F, E] = MovementAction(-maxSpeed, -maxSpeed)
   ...
   */
  infix def turnLeft[F[_], E <: DynamicEntity]: MovementAction[F, E] = MovementAction(-halfSpeed, halfSpeed)
   ...
   */
  infix def turnRight[F[_], E <: DynamicEntity]: MovementAction[F, E] = MovementAction(halfSpeed, -halfSpeed)
   ...
   */
  infix def stop[F[_], E <: DynamicEntity]: MovementAction[F, E] = MovementAction(zeroSpeed, zeroSpeed)
