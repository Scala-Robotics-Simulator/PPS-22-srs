...
import io.github.srs.model.logic.RobotActionLogic.given
import io.github.srs.model.logic.CollisionLogic.given
...
trait LogicsBundle[S <: State]:
  ...
  def robotAction: RobotActionLogic[S]
...
given simulationStateLogicsBundle: LogicsBundle[SimulationState] with
  ...
  val robotAction: RobotActionLogic[SimulationState] = summon[RobotActionLogic[SimulationState]]
  val collision: CollisionLogic[SimulationState] = summon[CollisionLogic[SimulationState]]
