...
object SquidLibFovEngine extends FovEngine:
   ...
   *
   * Delegates to [[squidpony.squidgrid.FOV.reuseFOV]] using the provided occlusion grid, writing into a reusable
   * buffer, and finally flattens the matrix in row-major order.
   *
   * @param occlusionGrid
